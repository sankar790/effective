...
import com.techies.effective.*;
import android.content.*;

public class ChildBrowser extends Plugin {
	public String myvalue;
	String myvalue1=myvalue;
    ...
    public PluginResult execute(String action, JSONArray args, String callbackId) {
		...
		//Parse.initialize(context.getApplicationContext(), "qe8urZso7npleQXKRxv9VrnaBwOdQ0sHYjZLvNbC", "tMN2h8yuW4mX9HgG9BUZOZ4q9W7LDOPOwt0gMvpL");
        PluginResult.Status status = PluginResult.Status.OK;
        String result = "";
        Log.d(LOG_TAG, "asdfasfasdasasdf----------------------Should never happen-------------------");
        try {
    ...
    private void logout() {
        Log.d(LOG_TAG, "---sankar----ChildBrowser: Error loading url");
    ...
    //	Parse.initialize(this, "qe8urZso7npleQXKRxv9VrnaBwOdQ0sHYjZLvNbC", "tMN2h8yuW4mX9HgG9BUZOZ4q9W7LDOPOwt0gMvpL"); 
        //   PushService.subscribe(this, "fooss", Effective.class);
