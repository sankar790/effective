  ...
  public boolean execute(String action, JSONArray data, CallbackContext callbackContext)
  {
    ...
    if (REGISTER.equals(action)) {
      ...
      try {
		...
		//Toast.makeText(this.cordova.getActivity(), "regid: " + regId, Toast.LENGTH_LONG).show();
		//Toast.makeText(this.cordova.getActivity(), "New Message: " + gSenderID, Toast.LENGTH_LONG).show();
