package com.techies.effective; //Edit this to match the name of your application
...
public class GCMIntentService extends GCMBaseIntentService {
  ...
  protected void onMessage(Context context, Intent intent) {
    ...
    if (extras != null) {
      try
      {
        ...
        //
        Toast.makeText(getApplicationContext(), "New Message: " + extras.getString("message"), Toast.LENGTH_LONG).show();
  ...
  public void onError(Context context, String errorId) {
    ...
    Log.e(TAG, "onError - errorId: " + context);
  }
