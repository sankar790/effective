            ...
            a.extend(this._date.prototype, {
                ...
                adj: function (c, b) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                     var ad=this.getMinutes()%10
                             console.log(ad);
                             if(ad<5 && ad !=0){
                                var timemin=this.getMinutes()+5-ad;
                                this.setMinutes(this.getMinutes() + 5*b +5-ad);
                                
                             }
                             else if(ad==5 || ad==0){
                             this.setMinutes(this.getMinutes() + 5*b);
                             }
                             else{
                               var timemin=this.getMinutes()+10-ad;
                               this.setMinutes(this.getMinutes() + 5*b+10-ad);
                             }
        ...
        _event: function (d, c) {
            ...
            if (!d.isPropagationStopped()) {
                ...
                case "open":
                    ...
                    break;
                case "set":
                     if(c.value.indexOf("AM")!=-1 || c.value.indexOf("PM")  !=-1){
                     String.prototype.replaceAt=function(index, character) {
      return this.substr(0, index) + character + this.substr(index+character.length);
   }
        //c.value="12:08 AM";
                          //  alert(c.value.charAt(4))
                            var ad=parseInt(c.value.charAt(4))
                            if(ad<5 && ad !=0){
                               var fvalue=c.value.replaceAt(4,"5");
                               c.value=fvalue;
                               //alert(fvalue);
                             ...
                             // var fvalue=c.value;
                              //c.value=fvalue;
                               ...
                               var fvalue=c.value.replaceAt(4,"0");
                                var ad1=parseInt(c.value.charAt(3));
                                if(ad1<5 ){
                                      ad1=ad1+1;
                                      //alert(ad1.toString())
                                      //alert(fvalue)
                                       var fvalue1=fvalue.replaceAt(3,ad1.toString());
                                       c.value=fvalue1;
                               //alert(fvalue1);
                                }
                                else{
        ...
        __: function (d) {
            var c = this.options,
                b = "override" + d.charAt(0).toUpperCase() + d.slice(1);
        ...
        _create: function () {
            ...
            var j = this,
                b = a.extend(this.options, (typeof this.element.jqmData("options") !== "undefined") ? this.element.jqmData("options") : this._getLongOptions(this.element)),
                k = (b.theme === false && typeof (a(this).jqmData("theme")) === "undefined") ? ((typeof (this.element.parentsUntil(":jqmData(theme)").parent().jqmData("theme")) === "undefined") ? b.themeDefault : this.element.parentsUntil(":jqmData(theme)").parent().jqmData("theme")) : b.theme,
                l = b.useAnimation ? b.transition : "none",
                g = b.useNewStyle === false ? {
                    input: this.element,
                    ...
                    mainWrap: a("<div>", {
                        "class": "ui-datebox-container ui-overlay-shadow ui-corner-all ui-datebox-hidden " + l + " ui-body-" + k
                    }).css("zIndex", b.zindex),
                    intHTML: false
                } : {
                    input: this.element,
                    ...
                    intHTML: false
                }, e = (typeof window.ontouchstart !== "undefined"),
                f = {
            ...
            j.d.screen = a("<div>", {
                "class": "ui-datebox-screen ui-datebox-hidden" + ((b.useModal) ? " ui-datebox-screen-modal" : "")
            }).css({
                "z-index": b.zindex - 1
        ...
        open: function () {
            var b = this,
                ...
                c = g.useAnimation ? g.transition : "none";
