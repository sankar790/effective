...
receivedEvent: function (id) {
	...
	// pushNotification.register(successHandler, errorHandler, {"senderID":"1020523470316","ecb":"onNotificationGCM"}); 
...
function sendNotifiaction(evt,eday,ehour,emin){
    ...
    var message12=Name+' have  invited you an event '+evt;
	...
	if(idarray1.length>0){
		...
		query.find({
                   ...
                   //html11 +='<fieldset><input type="text" data-mid="'+Anserides+'" value="'+results[0].get('mulquestion')+'" readyonly="ture"></fieldset>'
                    html1 +='<div class="bar_graph1" id="mulq_a">'+results[0].get('mulquestion')+'</div>'
